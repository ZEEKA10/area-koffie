    ...
    <nav class="bg-coffee-light p-4 sticky top-0 z-10">
        <div class="container mx-auto flex flex-wrap justify-between items-center">
            ...
            <div id="menu" class="hidden w-full lg:flex lg:w-auto lg:space-x-4">
                ...
                <a href="views/login.php" class="block mt-4 lg:inline-block lg:mt-0 hover:text-gray-300">Tambah Menu</a>
            </div>
        </div>
    </nav>
...
?>
   ...
   <?php while($menu = mysqli_fetch_assoc($menusResult)) { ?>
       <div class="cursor-pointer" onclick="openModal('<?= $menu['nama_menu'] ?>', '<?= $menu['deskripsi'] ?>', '/area-koffie/src/uploads/<?= $menu['foto'] ?>')">
           <div class="bg-coffee-light rounded-lg p-2 hover:shadow-lg transition">
               <img src="/area-koffie/src/uploads/<?= $menu['foto'] ?>" alt="<?= $menu['nama_menu'] ?>" class="w-full h-40 object-cover rounded mb-2">
